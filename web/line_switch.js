...
function text() {
  return isChinese()
    ? {
        lineTitle: "TerryXu 线路切换器",
        boolTitle: "TerryXu 二路布尔切换器",
        remoteTitle: "TerryXu 远程控制器",
        index: "线路",
        route: "线路",
        bool: "切换",
        falseInput: "关闭",
        ...
        lineChannel: "线路切换",
        boolChannel: "布尔切换",
        remoteDescription: "按频道自动识别 TerryXu 节点控件，并生成对应的远程控制界面。",
      }
    : {
        lineTitle: "TerryXu Line Switch",
        boolTitle: "TerryXu Boolean Switch",
        remoteTitle: "TerryXu Remote Control",
        index: "Route",
        route: "Route",
        bool: "Switch",
        falseInput: "Off",
        ...
        remoteDescription: "Detect TerryXu node controls by channel and build a matching remote control UI.",
      };
}
